...
\small $^1$Independent Researcher, Ontological Cosmology Research Initiative\\
\small $^*$Correspondence: fmolinaburgos@example.com
}
...
\bibitem{planck2018} Planck Collaboration. Planck 2018 results. VII. Isotropy and statistics of the CMB. \textit{A\&A} \textbf{641}, A7 (2020).

\bibitem{schwarz2004} Schwarz, D. J. et al. Is the low-$\ell$ microwave background cosmic? \textit{Phys. Rev. Lett.} \textbf{93}, 221301 (2004).

\bibitem{eriksen2004} Eriksen, H. K. et al. Asymmetries in the CMB anisotropy field. \textit{ApJ} \textbf{605}, 14 (2004).

\bibitem{cruz2005} Cruz, M. et al. Detection of a non-Gaussian spot in WMAP. \textit{MNRAS} \textbf{356}, 29 (2005).

\bibitem{kim2010} Kim, J. \& Naselsky, P. Anomalous parity asymmetry of CMB. \textit{ApJ} \textbf{714}, L265 (2010).

\bibitem{abbott2016} Abbott, B. P. et al. Observation of gravitational waves from a binary black hole merger. \textit{Phys. Rev. Lett.} \textbf{116}, 061102 (2016).

\bibitem{gwtc3} The LIGO-Virgo-KAGRA Collaboration. GWTC-3: Compact binary coalescences observed by LIGO and Virgo during the second part of the third observing run. \textit{Phys. Rev. X} \textbf{13}, 041039 (2023).

\bibitem{mobius2024} Molina Burgos, F. Cyclic Topo-Holographic Ontology: A geometric framework for emergent spacetime. \textit{Preprint} (2024).

\bibitem{berti2009} Berti, E., Cardoso, V. \& Starinets, A. O. Quasinormal modes of black holes and black branes. \textit{Class. Quantum Grav.} \textbf{26}, 163001 (2009).

\bibitem{bousso2002} Bousso, R. The holographic principle. \textit{Rev. Mod. Phys.} \textbf{74}, 825 (2002).

\bibitem{linde2008} Linde, A. Inflationary cosmology. \textit{Lect. Notes Phys.} \textbf{738}, 1 (2008).

\bibitem{isi2019} Isi, M. et al. Testing the no-hair theorem with GW150914. \textit{Phys. Rev. Lett.} \textbf{123}, 111102 (2019).

\bibitem{abbott2017triple} Abbott, B. P. et al. GW170814: A three-detector observation of gravitational waves from a binary black hole coalescence. \textit{Phys. Rev. Lett.} \textbf{119}, 141101 (2017).
